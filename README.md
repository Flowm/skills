...
| [comment-cleanup](skills/comment-cleanup/SKILL.md) | Remove comments that say nothing the code doesn't, and reword the survivors to be as concise as possible |
